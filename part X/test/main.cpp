...
int main( int argc, char** argv )
{
    ...
    Eigen::Quaterniond quaternion( -0.0151,0.0003 ,0.8609 ,-0.5085);
    quaternion=quaternion.normalized();
    Eigen::Isometry3d T_one(quaternion);
    T_one.pretranslate( Eigen::Vector3d( -0.6821, 2.6914, 1.7371 ) );

    v->setId( currIndex );
    v->setEstimate( T_one ); //估计为单位矩阵
